...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.login = function (userData) {
        ...
        this.http
            .post(url, userData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["timeout"])(45000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) {
            ...
            _this.spinnerLoad = false;
            _this.spinner.hide();
            _this.toastr.error("Error Occured. Kindly try again in error", "", {
                timeOut: 5000,
                enableHtml: true,
                closeButton: true,
                toastClass: "alert alert-danger alert-with-icon",
