...
/***/ "./src/app/pages/helper.service.ts":
/*!*****************************************!*\
  !*** ./src/app/pages/helper.service.ts ***!
  \*****************************************/
...
var HelperService = /** @class */ (function () {
    function HelperService(spinner, http, toastr, router) {
    ...
    ////////////GET DETAILS CALL////////////////////
    HelperService.prototype.getDataCall = function (url) {
        console.log(url);
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return response; }));
    };
    ///////////////////////////////////////////
    HelperService.prototype.putCall = function (url, data) {
        this.spinnerLoad = true;
        this.spinner.show();
    };
    HelperService.prototype.postCall = function (url, data, headers) {
        var _this = this;
        this.spinnerLoad = true;
        this.spinner.show();
        this.http.post(url, data, { headers: headers }).subscribe({
            next: function (data) {
                _this.data = data;
                console.log(data);
                if (_this.data.errCode == 0) {
                    return _this.data;
                }
                else {
                    var msg = void 0;
                    if (_this.data.errCode == 1 || _this.data.errCode == 2 || _this.data.errCode == 9) {
                        msg = _this.data.errMsg;
                    }
                    else {
                        msg = 'Error Occured during operation';
                    }
                    _this.errorSpecifiedToast(JSON.stringify(_this.data), msg);
                    return false;
                }
            },
            error: function (error) {
                ...
                _this.errorDefaultToast(error);
                return false;
            }
        });
    };
    HelperService.prototype.uploadOneFileCall = function (url, uploadFile, headers, successurl) {
        var _this = this;
        ...
        this.http.post(url, formdata, { headers: headers }).subscribe({
            next: function (data) {
                ...
                console.log(data);
                if (_this.data.errCode == 0) {
                    _this.successAlert('File Upload Successful');
                    _this.router.navigate([successurl]);
                }
                else {
                    var msg = void 0;
                    if (_this.data.errCode == 1 || _this.data.errCode == 2 || _this.data.errCode == 9) {
    ...
    HelperService.prototype.uploadTwoFilesCall = function (igorurl, atmurl, igorFile, atmFile, headers, successurl) {
        var _this = this;
        var formdata = new FormData();
        formdata.append('file', igorFile);
        this.spinnerLoad = true;
        this.spinner.show();
        this.http.post(igorurl, formdata, { headers: headers }).subscribe({
            next: function (data) {
                _this.data = data;
                console.log(data);
                if (_this.data.errCode == 0) {
                    _this.uploadOneFileCall(atmurl, atmFile, headers, successurl);
                }
                else {
                    var msg = void 0;
                    if (_this.data.errCode == 1 || _this.data.errCode == 2 || _this.data.errCode == 9) {
    ...
    HelperService.prototype.errorDefaultToast = function (error) {
        var _this = this;
        this.spinnerLoad = false;
        setTimeout(function () { return _this.spinner.hide(); }, 500);
        console.error('There was an error!', error);
        this.toastr.error('<span class="now-ui-icons ui-1_bell-53"></span> Error Occured', "", {
            timeOut: 5000,
            enableHtml: true,
            closeButton: true,
    ...
    HelperService.prototype.errorSpecifiedToast = function (error, message) {
        var _this = this;
        this.spinnerLoad = false;
        setTimeout(function () { return _this.spinner.hide(); }, 500);
        console.error('There was an error!', error);
    ...
    HelperService.prototype.infoToast = function (message) {
    ...
    HelperService.prototype.warningToast = function (message) {
    ...
    HelperService.prototype.successToast = function (message) {
        var _this = this;
        this.spinnerLoad = false;
        setTimeout(function () { return _this.spinner.hide(); }, 500);
    ...
    HelperService.prototype.successAlert = function (message) {
        var _this = this;
        setTimeout(function () { return _this.spinner.hide(); }, 5000);
        this.spinnerLoad = false;
    ...
    HelperService.prototype.reloadCurrentRoute = function () {
        var _this = this;
    ...
    HelperService.prototype.confirmProcess = function (message) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()({
            text: message,
            type: "warning",
    ...
    HelperService.prototype.cancelAlert = function () {
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()({
            title: "Cancelled",
            type: "error",
    ...
    HelperService = __decorate([
        ...
        __metadata("design:paramtypes", [ngx_spinner__WEBPACK_IMPORTED_MODULE_5__["NgxSpinnerService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], HelperService);
...
/***/ "./src/app/pages/users/service.service.ts":
/*!************************************************!*\
  !*** ./src/app/pages/users/service.service.ts ***!
  \************************************************/
...
var Service = /** @class */ (function () {
    ...
    //requestTimeout=5000
    ///////////////////NEC///////////////////////
    Service.prototype.confirmNecSubmit = function (data) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()({
            //title: "Are you sure?",
            text: "Are you sure you want to submit " + data.count + " requests for " + data.destAccount + " to " + data.destBank,
            type: "warning",
            showCancelButton: true,
            confirmButtonText: "Confirm",
            cancelButtonText: "Cancel",
            ...
            if (result.value) {
                _this.necData = _this.sendNec(data);
                //return response;
            }
            else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()({
    ...
    Service.prototype.getBanks = function () {
        var url = this.root_url + '/blaster/api/v1/banks';
        var bankList = this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return response; }));
        return bankList;
    };
    Service.prototype.clearTable = function (status) {
        var _this = this;
        this.spinnerLoad = true;
        this.spinner.show();
        var url = this.root_url + '/blaster/api/v1/clear';
        if (!status) {
            url = url + '/' + this.user;
        }
        return this.http.post(url, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["timeout"])(this.requestTimeout), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            console.log(error);
            if (error.name === 'TimeoutError') {
                console.error('Request timed out:', error);
                _this.spinnerLoad = false;
                _this.spinner.hide();
                _this.toastr.error("Request Timed Out. Kindly try again", "", {
                    timeOut: 5000,
                    enableHtml: true,
                    closeButton: true,
                    toastClass: "alert alert-danger alert-with-icon",
            ...
            _this.spinnerLoad = false;
            _this.spinner.hide();
            _this.toastr.error("Error Occured. Kindly try again", "", {
                timeOut: 5000,
                enableHtml: true,
                closeButton: true,
                toastClass: "alert alert-danger alert-with-icon",
    ...
    Service.prototype.sendNec = function (userData) {
        var _this = this;
        var url = this.root_url + '/blaster/api/v1/nec';
        this.spinnerLoad = true;
        this.spinner.show();
        //return this.http.post(url, userData).pipe(map((response: Response)=> response))
        return this.http.post(url, userData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["timeout"])(this.requestTimeout), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            console.log(error);
            if (error.name === 'TimeoutError') {
                console.error('Request timed out:', error);
                _this.spinnerLoad = false;
    ...
    Service.prototype.getNecs = function () {
        var url = this.root_url + '/blaster/api/v1/nec_list';
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["timeout"])(this.requestTimeout), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return response; }));
    };
    Service.prototype.successToast = function (msg) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".header-wrap {\r\n    white-space: normal !important;\r\n    word-wrap: break-word !important;\r\n  }\r\n\r\n.align-down{\r\n  padding-top: 10px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./service.service */ "./src/app/pages/users/service.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.all.js");
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _helper_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../helper.service */ "./src/app/pages/helper.service.ts");
...
var UsersComponent = /** @class */ (function () {
    ...
    function UsersComponent(helper, router, modalService, formBuilder, service) {
        this.helper = helper;
        this.router = router;
    ...
    UsersComponent.prototype.ngOnInit = function () {
        ...
        this.service.getBanks().subscribe(function (data) {
            _this.dropdownList = data;
            _this.dropdownList.forEach(function (element, i) {
                element.itemName = element.bankName;
                element.id = element.bankCode;
            });
            console.log(_this.dropdownList);
        }, function (error) { console.log(error); }, function () { console.log('terminated'); });
        // this.dropdownList = [
        ...
        this.registerForm = this.formBuilder.group({
            destBank: [, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            destAccount: ["", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            count: [1, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].min(1), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].max(5)]],
            createdBy: this.user
        });
    ...
    ///dropdown branch///
    UsersComponent.prototype.onItemSelect = function (item) { };
    UsersComponent.prototype.OnItemDeSelect = function (item) {
        console.log(item);
        console.log(this.selectedItems);
    };
    UsersComponent.prototype.onSelectAll = function (items) {
        console.log(items);
    };
    UsersComponent.prototype.onDeSelectAll = function (items) {
        console.log(this.selectedItems);
        //console.log(this.selectedItems[0].itemName)
        this.selectedItems = [];
        this.registerForm.patchValue({ branch: null });
    };
    UsersComponent.prototype.onItemSelect1 = function (item) {
        //alert('type selected')
        console.log(item);
    };
    UsersComponent.prototype.OnItemDeSelect1 = function (item) {
        console.log(item);
        console.log(this.selectedItems);
    };
    UsersComponent.prototype.onSelectAll1 = function (items) {
        console.log(items);
    };
    UsersComponent.prototype.onDeSelectAll1 = function (items) {
        this.selectedItems1 = [];
        this.registerForm.patchValue({ type: null });
    };
    UsersComponent.prototype.onItemSelectProd = function (item) {
        this.productSelectedItems = [];
        this.productSelectedItems.push(item);
    };
    UsersComponent.prototype.OnItemDeSelectProd = function (item) { };
    UsersComponent.prototype.onSelectAllProd = function (items) { };
    UsersComponent.prototype.onDeSelectAllProd = function (items) { };
    Object.defineProperty(UsersComponent.prototype, "registerF", {
        /////////////
        get: function () {
    ...
    Object.defineProperty(UsersComponent.prototype, "editF", {
        get: function () {
            return this.registerForm.controls;
        },
        enumerable: true,
    ...
    UsersComponent.prototype.onRegister = function () {
    ...
    ////modal///////////////////
    UsersComponent.prototype.open = function (content, type, modalDimension) {
        var _this = this;
        this.modalService.open(content, { size: "lg", centered: true }).result.then(function (result) {
            _this.closeResult = "Closed with: " + result;
        }, function (reason) {
            _this.closeResult = "Dismissed " + _this.getDismissReason(reason);
        });
    };
    UsersComponent.prototype.openEdit = function (content, type, modalDimension, value) {
        var _this = this;
    ...
    UsersComponent.prototype.openClearModal = function (content, type, modalDimension, value) {
        var _this = this;
        this.editRecord = value;
        this.modalService.open(content, { size: "md", centered: true }).result.then(function (result) {
            _this.closeResult = "Closed with: " + result;
        }, function (reason) {
            _this.closeResult = "Dismissed " + _this.getDismissReason(reason);
        });
    ...
    UsersComponent.prototype.onSelect = function ($event) {
        //console.log("Select Event", $event);
    };
    UsersComponent.prototype.onActivate = function (event) {
        this.activeRow = event.row;
    };
    UsersComponent.prototype.loadTable = function () {
        var _this = this;
        this.rows = [];
        this.temp = [];
        // this.rows = [
        ...
        //   },
        // ];
        this.service.getNecs().subscribe(function (data) {
            _this.rows = data;
        ...
        }, function (error) { console.log(error); }, function () { console.log('al necs loaded'); });
        this.modalService.dismissAll();
        this.service.spinnerLoad = false;
    };
    UsersComponent.prototype.reloadCurrentRoute = function () {
        var _this = this;
        var currentUrl = this.router.url;
        this.router.navigateByUrl('/app/home', { skipLocationChange: true }).then(function () {
            _this.router.navigate([currentUrl]);
        });
    };
    UsersComponent.prototype.confirmClearTable = function (status) {
        var _this = this;
        var warningMessage = "Are you sure you want to remove all current NEC Requests?";
        if (!status) {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default()({
            ...
            if (result.value) {
                _this.service.clearTable(status).subscribe(function () {
                    _this.loadTable();
                    _this.service.successToast('Nec list cleared successfully.');
                });
                _this.modalService.dismissAll();
                _this.service.spinnerLoad = false;
            }
            else {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default()({
                    title: "Cancelled",
    ...
    UsersComponent.prototype.submitNec = function (data) {
        var _this = this;
        console.log('nec req', data);
        this.service.sendNec(data).subscribe(function (data) {
            console.log("data", data);
            _this.rows = data;
            console.log("data", _this.rows);
            _this.temp = _this.rows.map(function (prop, key) {
                return __assign(__assign({}, prop), { id: key });
            });
            _this.modalService.dismissAll();
    ...
    UsersComponent.prototype.confirmCancel = function (data) {
        var _this = this;
        this.service.spinnerLoad = false;
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default()({
            //title: "Are you sure?",
            ...
            if (result.value) {
                ...
                _this.service.spinnerLoad = true;
            }
        });
    };
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("productDropdown"),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], UsersComponent.prototype, "pDrop", void 0);
    UsersComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_helper_service__WEBPACK_IMPORTED_MODULE_6__["HelperService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbModal"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            _service_service__WEBPACK_IMPORTED_MODULE_3__["Service"]])
    ], UsersComponent);
...
/* harmony import */ var _users_routing__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./users.routing */ "./src/app/pages/users/users.routing.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var angular2_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! angular2-multiselect-dropdown */ "./node_modules/angular2-multiselect-dropdown/fesm5/angular2-multiselect-dropdown.js");
    ...
    UsersModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(_users_routing__WEBPACK_IMPORTED_MODULE_8__["UsersRoutes"]),
            ...
            exports: [_users_component__WEBPACK_IMPORTED_MODULE_7__["UsersComponent"]]
        })
    ], UsersModule);
    return UsersModule;
}());
...
/* harmony import */ var _users_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./users.component */ "./src/app/pages/users/users.component.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
